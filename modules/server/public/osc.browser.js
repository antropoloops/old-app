(function(global, factory) {
  ...
  var AtomicInt32 = (function(_Atomic) {
    ...
    function AtomicInt32(value) {
      ...
      return possibleConstructorReturn(
        this,
        (AtomicInt32.__proto__ || Object.getPrototypeOf(AtomicInt32)).call(
          this,
          value
        )
      );
    ...
    createClass(AtomicInt32, [
      {
        ...
        value: function pack() {
          return get(
            AtomicInt32.prototype.__proto__ ||
              Object.getPrototypeOf(AtomicInt32.prototype),
            "pack",
            this
      ...
      },
      {
        ...
        value: function unpack(dataView$$1) {
          ...
          return get(
            ...
            "unpack",
            this
          ).call(this, dataView$$1, "getInt32", 4, initialOffset);
        }
      }
    ]);
    return AtomicInt32;
  ...
  var AtomicFloat32 = (function(_Atomic) {
    ...
    function AtomicFloat32(value) {
      ...
      return possibleConstructorReturn(
        this,
        (AtomicFloat32.__proto__ || Object.getPrototypeOf(AtomicFloat32)).call(
          this,
          value
        )
      );
    ...
    createClass(AtomicFloat32, [
      {
        ...
        value: function pack() {
          return get(
            AtomicFloat32.prototype.__proto__ ||
              Object.getPrototypeOf(AtomicFloat32.prototype),
            "pack",
            this
      ...
      },
      {
        ...
        value: function unpack(dataView$$1) {
          ...
          return get(
            ...
            "unpack",
            this
          ).call(this, dataView$$1, "getFloat32", 4, initialOffset);
        }
      }
    ]);
  ...
  var AtomicString = (function(_Atomic) {
    ...
    function AtomicString(value) {
      ...
      return possibleConstructorReturn(
        this,
        (AtomicString.__proto__ || Object.getPrototypeOf(AtomicString)).call(
          this,
          value
        )
      );
  ...
  var AtomicBlob = (function(_Atomic) {
    ...
    function AtomicBlob(value) {
      ...
      return possibleConstructorReturn(
        this,
        (AtomicBlob.__proto__ || Object.getPrototypeOf(AtomicBlob)).call(
          this,
          value
        )
      );
  ...
  var AtomicTimetag = (function(_Atomic) {
    ...
    function AtomicTimetag() {
      ...
      return possibleConstructorReturn(
        this,
        (AtomicTimetag.__proto__ || Object.getPrototypeOf(AtomicTimetag)).call(
          this,
          timetag
        )
      );
      ...
      },
      {
        ...
        value: function on(name, callback) {
          ...
          if (regex.test(address.split("/").join(""))) {
            throw new Error(
              "OSC EventHandler address string contains invalid characters"
            );
          }
    ...
    createClass(OSC, [
      ...
      },
      {
        ...
        value: function status() {
          if (
            !(this.options.plugin && isFunction(this.options.plugin.status))
          ) {
  ...
  var OSC$1 = (function(_OSCBase) {
    ...
    function OSC$$1(options) {
      ...
      return possibleConstructorReturn(
        this,
        (OSC$$1.__proto__ || Object.getPrototypeOf(OSC$$1)).call(
          this,
          Object.assign({}, defaultOptions$3, options)
        )
      );
    }
    return OSC$$1;
